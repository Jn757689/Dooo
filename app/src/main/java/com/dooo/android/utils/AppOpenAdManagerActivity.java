...
//        Notix.Companion.setLogLevel(LogLevel.FULL);
        NotixPush.Companion.init(this, "1005f9bcd64ec6829187acc5b6ec28f", "3a0a0af899ab4eb3b11258b4b4669c05");
        interstitialLoader = NotixInterstitial.Companion.createLoader(6240059L);
